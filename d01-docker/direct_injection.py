...
from mock_llm import GenerationResult, guarded_generate, naive_generate
from real_llm import DEFAULT_MODEL, guarded_generate_real, is_ollama_available, naive_generate_real
from prompts import (
